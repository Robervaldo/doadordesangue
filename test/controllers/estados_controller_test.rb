...
class EstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post estados_url, params: { estado: { EST_NOME: @estado.EST_NOME, EST_SIGLA: @estado.EST_SIGLA } }
    end
  ...
  test "should update estado" do
    patch estado_url(@estado), params: { estado: { EST_NOME: @estado.EST_NOME, EST_SIGLA: @estado.EST_SIGLA } }
